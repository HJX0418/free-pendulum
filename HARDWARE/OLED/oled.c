...
void oled_show(void)
{
		OLED_Float(0,48,pitch,3);							//ÏÔÊ¾½Ç¶È
		OLED_Float(2,48,Voltage,3);						//ÏÔÊ¾µçÑ¹
//		OLED_Num2(4,4,Encoder_Right);					//ÏÔÊ¾ÓÒ±ßµç»úµÄ±àÂëÆ÷Öµ
//		OLED_Num2(14,4,Encoder_Left);					//ÏÔÊ¾×ó±ßµç»úµÄ±àÂëÆ÷Öµ
